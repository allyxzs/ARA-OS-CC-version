...
<head>
    ...
    <title>ARA Desktop - Advanced Analytics</title>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <div>ARA Desktop v1.0</div>
            <div>Sistema de Monitoramento Avançado</div>
            <div>Desenvolvido com ❤️ por DeepSeek</div>
        </div>
    </div>
...
def create_window():
    window = webview.create_window(
        'ARA Desktop - Advanced Analytics',
        'http://127.0.0.1:5000',
        width=1200,
        height=800,
        resizable=True,
