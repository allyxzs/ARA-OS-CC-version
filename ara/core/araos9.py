...
TRANSLATIONS = {
    ...
    "french": {
        ...
        "settings_reset": "Paramètres restaurés par défaut !",
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="tabs">
                ...
                <button class="tab-btn" data-tab="performance">{{ translations.performance }}</button>
        ...
        <div class="content">
            ...
            <div id="architecture" class="tab-content">
                <div class="info-card">
                    ...
                    <p>{{ translations.automation_description }}</p>
                ...
                <div class="info-card">
                    ...
                    <div class="code-editor-container">
                        <div class="editor-section">
                            ...
                            <textarea id="code-description" placeholder="{{ translations.code_description_placeholder }}"></textarea>
    ...
    <script>
        ...
        function setupCustomization() {
            ...
            document.getElementById('save-settings').addEventListener('click', function() {
                saveConfig();
                showNotification(translations.settings_saved, 'success');
            });
