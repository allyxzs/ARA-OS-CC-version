...
DEFAULT_CONFIG = {
    ...
    "automation_rules": [],
    "language": "portuguese"  # Novo campo para idioma
}
                ...
                <div class="info-card">
                    ...
                    <div class="language-selector">
                        ...
                        <select id="language-select">
                            ...
                            <option value="english" {{ 'selected' if config.language == 'english' else '' }}>Inglês</option>
                            <option value="french" {{ 'selected' if config.language == 'french' else '' }}>Francês</option>
